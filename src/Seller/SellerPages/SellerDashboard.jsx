    ...
    <div className="seller-dashboard">
      <div className="welcome-card">
        <div className="welcome-card-content">
          <h1 className="dashboard-title">
            Welcome back, {seller?.fullName || seller?.userName || 'Admin'}!
      ...
      {analytics.topProducts.length > 0 && (
        <div className="analytics-overview-section">
          <div className="section-header">
            ...
            <button className="view-all-btn" onClick={() => navigate('/seller/analytics')}>
      ...
      <div className="quick-actions-section">
        ...
        <div className="quick-actions-grid">
          <button className="quick-action-card" onClick={() => navigate('/seller/add-product')}>
          ...
          <button className="quick-action-card" onClick={() => navigate('/seller/inventory')}>
          ...
          <button className="quick-action-card" onClick={() => navigate('/seller/orders')}>
      ...
      {stats.outOfStock > 0 && (
        <div className="alert-banner">
          ...
          <button className="alert-action" onClick={() => navigate('/seller/inventory')}>
            Update Stock
          </button>
        </div>
      )}
